...
![Stock vs Ephemeral vs Relay](assets/spacetimedb-membus-2.10.0-r1-stock-vs-ephemeral-vs-relay.png) · interactive: [2.10.0-R1 chart](db-membus-2.10.0-r1-ephemeral-relay-chart.html) (same three-way comparison; the raw rows follow)
